...
const movies = [
  {
    title: 'De Dana Dan',
    description: 'A comedy short film inspired by chaos, confusion, and mistaken identities.',
    thumbnailUrl:
  ...
  },
  {
    ...
    description: 'A documentary chronicling Lionel Messi’s journey to winning the FIFA World Cup.',
    thumbnailUrl:
  ...
  {
    title: 'In This Life',
    description: 'A romantic short film about love, loss, and destiny.',
    thumbnailUrl:
